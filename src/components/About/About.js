      ...
      <div className="container mx-auto lg:px-16 md:px-8 xl:pt-20 ">
        ...
        <div className="mt-2 lg:mt-20 px-4">
          ...
          <div className="mt-10 grid justify-between grid-flow-col">
            <div className="group">
              <div className="border-2 border-[#0788ff] w-12 h-12 md:w-16 md:h-16 rounded-full flex justify-center items-center mb-2 fill-[#0788ff] hover:bg-[#0788ff] hover:fill-current">
                <svg
